...
@media (min-width:760px){
  body{display:grid;place-items:center;padding:24px 24px 44px;background:
    radial-gradient(60% 50% at 50% 0,#173a25 0,transparent 70%),#0e1210;}
  #app{width:393px;height:min(852px,calc(100vh - 80px));border-radius:48px;border:10px solid #1b1f1d;
    box-shadow:0 30px 80px rgba(0,0,0,.6),inset 0 0 0 1px rgba(255,255,255,.06);}
  #app::-webkit-scrollbar{display:none;}
  .preview-note{position:fixed;left:0;right:0;bottom:12px;text-align:center;font:500 12px/1.4 -apple-system,"Segoe UI",Roboto,sans-serif;color:#7d8a82;}
}
